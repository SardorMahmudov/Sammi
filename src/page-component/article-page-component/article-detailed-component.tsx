      ...
      <Box>
          ...
          >
            {!speaking ? (
              <HStack
                onClick={() => {
                  speak({
                    text: `${t("start_reading_article", { ns: "global" })} ${article.title} ${t("article", { ns: "global" })}. ${
              ...
              <HStack onClick={cancel}>
                ...
                {speaking && <Image src="/images/wave.gif" alt="wave" pos={"absolute"} width={"50%"} right={0} />}
              </HStack>
            )}
          </Box>
        )}
        ...
        <RichText
          ...
          renderers={{
            ...
            img: (children) => (
              <Image src={children.src} alt={children.altText} width={children.width} height={children.height} />
            ),
