        ...
        <CardBody pos={"relative"} p={{ base: 2, md: 5 }}>
          <Stack direction={{ base: "column", md: "row" }} gap={5}>
            <Box w={{ base: "100%", md: "60%" }}>
              ...
              <Text mt={5}>
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Laboriosam quaerat exercitationem architecto quos at odio
                totam, doloribus dolorem asperiores. Animi?
              </Text>
